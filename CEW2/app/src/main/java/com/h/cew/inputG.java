...
public class inputG extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_g);
        member = new MemberG();
        refdata = FirebaseDatabase.getInstance().getReference().child("MemberG");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(inputG.this, retrieveG.class);
