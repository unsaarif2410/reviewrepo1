...
public class inputL extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_l);
        member = new MemberL();
        refdata = FirebaseDatabase.getInstance().getReference().child("MemberL");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(inputL.this, retrieveL.class);
