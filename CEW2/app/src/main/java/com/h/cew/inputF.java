...
public class inputF extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        member = new MemberF();
        refdata = FirebaseDatabase.getInstance().getReference().child("MemberF");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(inputF.this, retrieveF.class);
